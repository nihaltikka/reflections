...
def print_banner():
    ...
    {GREEN}#        {BOLD}Developed by elcazad0r{RESET}{GREEN}        #{RESET}
    {GREEN}#                                       #{RESET}
    {GREEN}#########################################{RESET}
    {BOLD}Usage:{RESET}                                #
    ...
    try:
        ...
        for param in parsed_url.query.split("&"):
            ...
            if len(key_value) == 1 or key_value[1] == "":
                query_params[key_value[0]] = ["elcazad0rXSS"]
        ...
        for param in query_params:
            ...
            # Temporarily set the current parameter to `elcazad0rXSS`
            modified_params[param] = ['elcazad0rXSS']
            ...
            # Check if 'elcazad0rXSS' is reflected in the response
